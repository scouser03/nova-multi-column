...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-multi-column', __webpack_require__(3));
  Vue.component('detail-multi-column', __webpack_require__(6));
  Vue.component('form-multi-column', __webpack_require__(9));
});
